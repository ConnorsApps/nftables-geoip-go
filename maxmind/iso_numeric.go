...
// isoNumericByAlpha2 maps ISO 3166-1 alpha-2 to ISO 3166-1 numeric (the nft mark value).
var isoNumericByAlpha2 = map[string]uint32{
...
var continentNameByMaxMindCode = map[string]string{
	"AF": "africa",
	"AN": "antarctica",
	"AS": "asia",
	"EU": "europe",
